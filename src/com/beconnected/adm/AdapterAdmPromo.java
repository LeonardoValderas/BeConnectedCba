...
public class AdapterAdmPromo extends ArrayAdapter<Empresa>
    {
        ...
        public AdapterAdmPromo(Activity context, int resource, ArrayList<Empresa> empresaArray)
        {
        ...
        {   // This view starts when we click the spinner.
            ...
            {   // Parse the data from each object and set it.
                 ImageView imageViewEscudo = (ImageView) row.findViewById(R.id.imageViewLogo);
                 imageViewEscudo.setVisibility(View.VISIBLE);
                TextView spinnerGeneral = (TextView) row.findViewById(R.id.empresaSpinner);
